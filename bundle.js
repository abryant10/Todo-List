        ...
        case ("completed"):
            switch (sortVal) {
                case ("priority"):
                    ...
                    break;
                case ("due-date"):
                    renderArray = _src_modules_Completed__WEBPACK_IMPORTED_MODULE_3__.completedTasks.slice().sort(function (a, b) {
                        var key1 = new Date(a.dueDate);
                        var key2 = new Date(b.dueDate);
                        if (key1 < key2) {
                            return -1;
...
function renderTaskView (list) {
    ...
    renderArray.forEach(task => { 
        ...
        if(task.dueDate != "") {
            renderedTaskDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__.default)((0,date_fns__WEBPACK_IMPORTED_MODULE_6__.default)(task.dueDate), 'M/d/y')
        }else {
